...
export default class RegistrationForm{
    ...
    events(){
        ...
        this.email.addEventListener("keyup", () => {
            this.isDefferent(this.email, this.emailHandler)
        })

        this.password.addEventListener("keyup", () => {
            this.isDefferent(this.password, this.passwordHandler)
        })
    ...
    passwordAfterDelay(){
        if(this.password.value.length < 8){
            this.showValidationError(this.password, "Passwors must be atleast 8 characters.")
        }
    }
    emailHandler(){
    ...
    usernameAfterDelay(){
        if(this.username.value.length < 3){
            this.showValidationError(this.username, "Username must be 3 characters.")
        }
